...
public class LexerGenerator extends CommonGenerator {

    public LexerGenerator(String dir, String name, ParserGrammar grammar) {
    ...
    private void printName() {
        printLine(0, "public class ", lexerName, " {", N);
    }
    ...
    private void printMethodSetRegex() {
        ...
        for (LexemRule rule : grammar.lexems) {
